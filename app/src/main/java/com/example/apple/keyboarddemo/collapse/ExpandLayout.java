...
public class ExpandLayout extends LinearLayout {
     ...
     */
    public void initExpand(boolean isExpand, ImageView imageView) {
    ...
    public void toggleExpand() {
        ...
        if (isExpand) {
            ObjectAnimator.ofFloat(mImageView, View.ROTATION.getName(), -180, 0).start();
            collapse();
        } else {
            ObjectAnimator.ofFloat(mImageView, View.ROTATION.getName(), 180, 0).start();
            expand();
